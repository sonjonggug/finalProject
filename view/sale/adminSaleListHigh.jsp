...
<!-- Begin Page Content -->
       ...
       <form action="/kherb/admin/sale/search/1" method="post">      
       ...
       <option value="/kherb/admin/sale/sort/${sort.value}/1">${sort.key} </option>  
        </c:forEach>      
        </select></div>  
            ...
            <!-- <td> <a onclick="input()"
                ...
                <td> <a onclick="ho('${SaleList.pname}');location.href='/kherb/admin/sale/${paging.pageNo}/info/1'" 
              >${SaleList.pname}</a></td>
                <!-- location.href='/kherb/admin/sale/${paging.pageNo}/info/1' -->
                 ...
                 <!--  <td> <a href= "javascript:void(0)" onClick="javascript:move(this)/${paging.pageNo}/info/1">${SaleList.pname}</a></td>-->  
                                      ...
                                      <td>${SaleList.sum}</td> 
                                  <td><button class="btn btn-primary" onclick="ho('${SaleList.pname}');location.href='/kherb/admin/sale/${paging.pageNo}/info/1'" 
              						>상세보기</button></td>
                                         </tr>
                                        </c:forEach>
...
<ul class="pagination">
			...
			<a href="/kherb/admin/sale/sort/high/${paging.startPage - paging.pageSize}"
			...
			<a href="/kherb/admin/sale/sort/high/${pNo}" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">${pNo}</a>
			</li>
			</c:if>
		
			<c:if test="${pNo eq paging.pageNo}">	<li class="paginate_button page_item">
			<a href="/kherb/admin/sale/sort/high/${pNo}" style="color:red;" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">${pNo}</a>
			</li></c:if>
